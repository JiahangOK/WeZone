...
public class NewFriendConversation extends Conversation{
    ...
    public Object getAvatar() {
        return R.mipmap.touxiang;
    }

    @Override
    public int getUnReadCount() {
        return NewFriendManager.getInstance(ImApplication.INSTANCE()).getNewInvitationCount();
    }

    @Override
    public void readAllMessages() {
        //批量更新未读未认证的消息为已读状态
        NewFriendManager.getInstance(ImApplication.INSTANCE()).updateBatchStatus();
    }
